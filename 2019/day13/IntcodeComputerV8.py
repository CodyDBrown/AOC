...
def IntcodeComputer(numbers,INPUT=0, INDEX = 0, REL_BASE = 0):  
    ...
    while(True):
        ...
        # Command 1, add the numbers together
        if comand == 1:
        ...
        # Command 2, multiply the numbers together
        elif comand == 2:
            firstNumber = modeCheck(modes[-1], 1)
            secondNumber = modeCheck(modes[-2], 2)
            if modes[-3] == '0':
        ...
        # Input command
            ...
            """
            For part 2 on day 13 I need an "AI" to play the block game for me.
            """
            if modes[-1] == '0':
        ...
        # Check if the input is equal to zero.
        elif comand == 6:
            firstParam = modeCheck(modes[-1], 1)
            secondParam = modeCheck(modes[-2], 2)
            if firstParam == 0:
        ...
        # If first number is less than second, output 1, else 0.
        elif comand == 7:
            firstParam = modeCheck(modes[-1],1 )
            secondParam = modeCheck(modes[-2], 2)
            outputMode = modes[-3]
        ...
        # Check if the numbers are equal to each other. If they are return 1,
        # else return 0. 
        elif comand == 8:
            firstParam = modeCheck(modes[-1],1 )
            secondParam = modeCheck(modes[-2], 2)
